...
const Formulario = () => {
    ...
    <>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className='my-5'>
                <label htmlFor="" className='block mb-3 font-bold text-gray-400 uppercase'>Elije un plan</label>
                <div className='felx gap-3 m-rigth' >
                    {PLANES.map(plan => (
                        <Fragment key={plan.id}>
                            ...
                            <input type="radio" name='plan' value={plan.id} onChange={e => handleChangeDatos(e)}/><br />
                        </Fragment>
                    ))}
                </div>
